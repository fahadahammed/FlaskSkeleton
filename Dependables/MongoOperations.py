...
class MDB_Operations:
    def __init__(self, collection_name=None):
        self.client = pymongo.MongoClient(app.config["{PROJECT_NAME}_DB_HOST"], app.config["{PROJECT_NAME}_DB_PORT"])
        database_name = str(app.config["{PROJECT_NAME}L_NAME"]).lower()
