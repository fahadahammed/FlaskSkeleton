...
MCONN = pymongo.MongoClient(app.config["kPROJECTNAMEFSKLTN_DB_HOST"], app.config["kPROJECTNAMEFSKLTN_DB_PORT"], connect=False)


class MongoOperations:
    def __init__(self, collection_name=None):
        self.client = MCONN
        database_name = str(app.config["PROJECTNAMEFSKLTN_DB_NAME"]).lower()
...
class DynamicName:
    def __init__(self):
        ...
        self.collection_name = "PROJECTNAMEFSKLTN" + str(self.str_year_month)
        self.database_name = "kPROJECTNAMEFSKLTN" + str(self.str_year)
