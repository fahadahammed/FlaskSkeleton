...
from {PROJECT_NAME} import app
import pymongo
from {PROJECT_NAME}.Library.DynamicName import DynamicName
from {PROJECT_NAME} import ncache
import datetime
...
class MDB_Operations:
    ...
    def __init__(self, collection_name=None):
        self.client = pymongo.MongoClient(app.config["{PROJECT_NAME}_MDB_HOST"], app.config["{PROJECT_NAME}_MDB_PORT"])
        database_name = str(app.config["{PROJECT_NAME}_MDB_NAME"]).lower()
